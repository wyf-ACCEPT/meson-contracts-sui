...
main = async () => {
    ...
    const message = 'stupid'
    const digest_hex = keccak256(Buffer.from(message))
    // const digest_hex = 'bd045242342bc4e3948a5029209b0e90e29e5a55dffff09113aa65b8ea997031'
    const digest_bytes = Buffer.from(digest_hex.slice(2), 'hex')
    ...
    const digest_bytes_with_header = keccak256(Buffer.from(header + digest_hex.slice(2), 'hex'))

    console.log(digest_bytes_with_header)
    console.log(digest_hex)
    ...
    console.log(recoverAddress(digest_hex, s2))
